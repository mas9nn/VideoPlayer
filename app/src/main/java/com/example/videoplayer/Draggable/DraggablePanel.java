...
public class DraggablePanel extends FrameLayout {
    ...
    private static final boolean DEFAULT_TOP_FRAGMENT_RESIZE = true;
    ...
    public void hideBottom() {
        bottomFragment.getView().setVisibility(GONE);
        second.setVisibility(GONE);
    }

    public void visibleBottom() {
        bottomFragment.getView().setVisibility(VISIBLE);
    }

    public void focus(Boolean bol) {
        draggableView.setFocusable(bol);
        draggableView.setEnabled(bol);
    }
    ...
    public void initializeView() {
        ...
        FrameLayout layout = findViewById(R.id.drag_view);
        second = findViewById(R.id.second_view);
       // draggableView.setTopViewHeight(layout.getHeight());
