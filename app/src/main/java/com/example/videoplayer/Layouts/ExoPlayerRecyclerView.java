package com.example.videoplayer.Layouts;
...
public class ExoPlayerRecyclerView extends RecyclerView {
     ...
     */
    // Media List
    private ArrayList<MainPageItems> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        if (play) {
            ...
            Log.wtf("postiontion", mediaObjects.size() + "");
    ...
    public void isPlayVideo(boolean play) {
        this.play = play;
    }
    ...
    private void addVideoView() {
        ...
        mediaCoverImage.setVisibility(INVISIBLE);
    }
    ...
    private void animateVolumeControl() {
        if (volumeControl != null) {
            ...
            if (volumeState == VolumeState.OFF) {
                requestManager.load(R.drawable.ic_favorite_blue)
                        .into(volumeControl);
            } else if (volumeState == VolumeState.ON) {
                requestManager.load(R.drawable.ic_favorite_black)
                        .into(volumeControl);
            }
    ...
    public void setMediaObjects(ArrayList<MainPageItems> mediaObjects) {
